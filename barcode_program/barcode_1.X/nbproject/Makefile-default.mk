...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/barcode_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ELB_I2C.o ${OBJECTDIR}/ELB_LCD.o ${OBJECTDIR}/ELB_OSC.o ${OBJECTDIR}/ELB_PWM.o ${OBJECTDIR}/ELB_Timer.o ${OBJECTDIR}/ELB_UART.o ${OBJECTDIR}/ELBv21_HardwareConfig.o ${OBJECTDIR}/FSIO.o ${OBJECTDIR}/SD-SPI.o ${OBJECTDIR}/main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/ELB_I2C.o.d ${OBJECTDIR}/ELB_LCD.o.d ${OBJECTDIR}/ELB_OSC.o.d ${OBJECTDIR}/ELB_PWM.o.d ${OBJECTDIR}/ELB_Timer.o.d ${OBJECTDIR}/ELB_UART.o.d ${OBJECTDIR}/ELBv21_HardwareConfig.o.d ${OBJECTDIR}/FSIO.o.d ${OBJECTDIR}/SD-SPI.o.d ${OBJECTDIR}/main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ELB_I2C.o ${OBJECTDIR}/ELB_LCD.o ${OBJECTDIR}/ELB_OSC.o ${OBJECTDIR}/ELB_PWM.o ${OBJECTDIR}/ELB_Timer.o ${OBJECTDIR}/ELB_UART.o ${OBJECTDIR}/ELBv21_HardwareConfig.o ${OBJECTDIR}/FSIO.o ${OBJECTDIR}/SD-SPI.o ${OBJECTDIR}/main.o
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/barcode_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/barcode_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -o dist/${CND_CONF}/${IMAGE_TYPE}/barcode_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__ICD2RAM=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1
else
dist/${CND_CONF}/${IMAGE_TYPE}/barcode_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -omf=elf -mcpu=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/barcode_1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}         -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
	${MP_CC_DIR}\\pic30-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/barcode_1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -omf=elf
endif
