...
// Sample clock speed for a 16-bit processor
    ...
    #define GetSystemClock()        32000000						//Brigosha Board - Jitesh
...
*/
        ...
        // Description: SD-SPI Chip Select Output bit
        #define SD_CS				LATDbits.LATD5		// Brigosha Board - SPI1_CS - PORT D5
        // Description: SD-SPI Chip Select TRIS bit
        #define SD_CS_TRIS          TRISDbits.TRISD5
        
        // Description: SD-SPI Card Detect Input bit
        #define SD_CD               0//PORTDbits.RD7		// Brigosha Board does not use the Card Detect input
        // Description: SD-SPI Card Detect TRIS bit
        #define SD_CD_TRIS          TRISDbits.TRISD7
        
        // Description: SD-SPI Write Protect Check Input bit
        #define SD_WE               0// PORTFbits.RF1		// Brigosha Board does not use the Write Protect Check input
        // Description: SD-SPI Write Protect Check TRIS bit
        ...
        // Description: The TRIS bit for the SCK pin
        #define SPICLOCK            TRISDbits.TRISD2		// Brigosha Board - SPI1_CLK - PORT D2
        // Description: The TRIS bit for the SDI pin
        #define SPIOUT               TRISDbits.TRISD4		// Brigosha Board - SPI1_DI - PORT D4
        // Description: The TRIS bit for the SDO pin
        #define SPIIN              TRISDbits.TRISD3		// Brigosha Board - SPI1_DO - PORT D3
